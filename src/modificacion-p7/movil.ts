...
export class Movil implements Ob.Observer {
    ...
    if (observable instanceof EstacionMeteorologica) {
      switch(observable.getEventType()) {
        case Ob.EventType.LLUVIA:
          return `Tu movil ${this._name} recibió notificación de que en media hora va a llover.\n`;
        case Ob.EventType.NIEVE:
          return `Tu movil ${this._name} recibió notificación de que en el Teide está nevando.\n`;
        case Ob.EventType.ALERTA_VIENTO:
          return `Tu movil ${this._name} recibió notificación de no se recomienda salir por Alerta de Viento.\n`;
        case Ob.EventType.TORNADO:
          return `Tu movil ${this._name} recibió notificación de que se avecina un Tornado entre el Lunes y el Martes.\n`;
      }
    } 
